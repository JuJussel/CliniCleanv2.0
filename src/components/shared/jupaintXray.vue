<template>
  <div>
    ...
    <div ref="canvasCont" style="position: relative">
      <canvas class="canvas" id="canvasImg2" :width="canvasSize.w" :height="canvasSize.h"></canvas>
      <canvas class="canvas temp" id="canvas2" :width="canvasSize.w" :height="canvasSize.h"></canvas>
      <canvas         class="canvas temp"
        id="canvasTemp2"
...
export default {
  ...
  props: ["parentWidth", "parentHeight", "schema"],
  data: function() {
    return {
      mounted: false,
      textToAdd: "",
  ...
  mounted: function() {
    this.mainCanvas.c = document.getElementById("canvasTemp2");
    this.mainCanvas.ctx = this.mainCanvas.c.getContext("2d");
    this.imageCanvas.c = document.getElementById("canvasImg2");
    this.imageCanvas.ctx = this.imageCanvas.c.getContext("2d");
    this.outputCanvas.c = document.getElementById("canvas2");
